...
<div>
   <Helmet>
  <title>7- El Análisis de Varianza (ANAVA)</title>
  <meta name="description" content="El Análisis de Varianza (ANAVA)"/>
  <meta name='keywords'
  content='ANAVA, analisis de varianza, ANAVA dos factores sin replicacion, ANAVA dos factores sin replicacion'/>
    </Helmet>
   <main>
...
<div id = "tabla" className = "container bg-light">
    <ContentsTable
      ...
      <Paragraph texto = {<>
        ...
        <ul>
          <li>- H<sub>0</sub>: No existe variación en la producción promedio de leche entre las granjas.</li>
...
<DownloadButton link = "https://github.com/HectorDR/vetDataScience/blob/hojas_excel/7.2_Anava_un_factor.xlsx?raw=true"/> 
      ...
      <p>Podemos utilizar El ANAVA de dos factores cuando  
        ...
        En otro ejemplo, deseamos conocer si los promedios de producción lechera en kg ajustada a 305 dias en una región lechera de Canadá y obtenidos a partir de muestras
        de 12 hatos lecheros representativos y discriminados por lactancias de la 1ª a la 5ª son diferentes entre ellos o no.<br/><br/>
     ...
     <ImagePlus
      ...
      <ImagePlus
        ...
        />
      <Paragraph texto = {<>
         <center> <h4> Seleccionar la opción ANAVA dos factores sin replicación</h4> </center><br/>
...
<DownloadButton link = "https://github.com/HectorDR/vetDataScience/blob/hojas_excel/7.3_Anava_dos_facts.xlsx?raw=true"/> 
      ...
      <Paragraph texto = {<>
        ...
        <ul>
          <li>1- Las medias de las variables medidas son iguales para los diferentes valores de la primera variable nominal;</li>
          <li> 2- Las medias son iguales para los diferentes valores de la segunda variable; </li>
          <li>3- No existe interacción (los efectos de una variable nominal no dependen de los valores de la otra variable nominal).</li>
        </ul><br/>
      ...
      <Paragraph texto = {<>
        ...
        <p>Inmediatamente se abre una hoja de diálogo que nos pide seleccionar el rango de las celdas donde se encuentra la tabla (incluir los encabezados), 
          y posteriormente se debe escribir el número de filas por cada muestra, para este caso son 6 por subregión (las subregiones están en las filas) se debe 
          tener en cuenta que son las mismas observaciones para cada muestra (subregión). Luego seleccionamos el 𝛼 (0.05) y finalmente el lugar donde se desea 
      ...
      <Paragraph texto = {<>
        ...
        <p>Una vez presionamos OK, Excel genera un reporte con toda la información (ver tabla inferior). El reporte esta dividido en dos tablas, 
          la primera  presenta el resumen descriptivo (numero de fincas, sumas, promedio y varianza) para cada subregión por año, así como para la totalidad, 
          y la segunda tabla presenta el ANAVA para las subregiones (Sample), para los años (Columns) y para la interacción de las dos variables.</p>
      </>}/>
      <ImagePlus
          image={rep4}
          texto="Reporte generado por Excel"
        ...
        subregiones. Para este caso el valor de F (8.27) es mayor que el F crítico (2.71) y el P-value es inferior a 0.0001 (inferior al valor de 𝛼 = 0.05) 
...
<DownloadButton link = "https://github.com/HectorDR/vetDataScience/blob/hojas_excel/7.4_Anava_dos_facts_replicacion.xlsx?raw=true"/> 
      ...
      <Paragraph texto= {<><p>
        En general la regresión lineal es una aproximación que describe una respuesta cuantitativa de Y (variable dependiente) basada en los valores un solo predictor X (variable independiente). Asume que hay una relación lineal entre X y Y y describe una función de una línea diagonal (James et al., 2013). Para medir esta asociación utilizamos el R<sup>2</sup>  que representa la proporción de la
        <HashLink smooth to={"/Analisis#dispersion"}><u>varianza</u></HashLink> que es explicada por el modelo propuesto con la  regresión lineal. Los valores de R<sup>2</sup> oscilan entre 0 y 1, siendo 1 el valor dado a un ajuste perfecto, es decir no habría residuales, la diferencia entre Y y los valores 
        predichos de Y seria igual a 0 (Macdonald, 2009) es decir un modelo perfecto (un unicornio). <br/>  
        Matemáticamente la regresión lineal se describe:
        </p></>}/>
        ...
        />
        <Paragraph texto  = {<><p>
          Donde el valor de Y esta dado por <b>𝛃<sub>0</sub></b> que es el intercepto o el valor de Y cuando X vale 0, <b> 𝛃<sub>1</sub></b> es la constante de la pendiente de <b>X<sub>1</sub></b> que es la variable independiente o predictor y <b>𝛆</b>  es el error. Este representa las diferencias entre el <b>Y</b> real y el <b>y</b> estimado pues muy seguramente la relación no es una diagonal perfecta, sino que hay variaciones. Típicamente se asume que el error 
          es independiente de X.<br/> <br/>
          ...
          (James et al.,2013; Macdonald, 2009).<br/> Para ilustrar la regresión lineal simple, veamos el gráfico adaptado de 
        ...
        <Paragraph texto = {<>
          ...
          <p>Como se puede observar existe una tendencia decreciente clara donde a mayor cantidad de lluvias hay una disminución en la producción de arroz 
            ...
            hay una asociación entre las dos variables. En este caso nos gustaría saber si realmente hay disminución de la cosecha por unidad de lluvia que cae. 
