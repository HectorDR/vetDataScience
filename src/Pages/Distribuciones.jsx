...
<p> La fórmula de la distribución de Poisson es: </p>
    ...
    texto = "Probabilidades para x número de partos a la semana, siguiendo la distribución de Poisson "
     /> 
     <Paragraph texto = "Utilizando el diagrama de barras podemos visualizar la curva de la distribucion de Poisson para el ejemplo anterior"/>
