...
<div>
   <Helmet>
  <title>5- Estadística descriptiva y análisis inicial de los datos</title>
  <meta name="description" content="Estadística descriptiva y análisis inicial de los datos"/>
  <meta name='keywords'
  content='datos categoricos,datos nominales, datos cuantitativos,visualizacion de variables, estadistica descriptiva, medidas de tendencia central, medidas de dispersion, covarianza, correlacion'/>
    </Helmet>
   <main>
    ...
    <ContentsTable
      ...
      <SubChapter id="categoricos">
        ...
        <Paragraph texto="Los datos categóricos son datos que se dividen en grupos como por ejemplo sexo (masculino, femenino) o raza (holstein, pardo suizo, normando). Veamos como podemos mostrar y resumir los datos categóricos con un ejemplo práctico."/>
    
        <Paragraph texto = "De una clínica veterinaria obtenemos una lista de historias clínicas de perros (n= 89). Queremos clasificar los animales por su tamaño, para ellos los hemos dividimos en tres categorias: grande, mediano y pequeño. De esta manera ya podremos cuantificar cuantos animales pertenecen a cada categoría y comenzar a entender por ejemplo que tipo de paciente es el que mas viene a la clínica."/>
...
<DownloadButton link = "https://github.com/HectorDR/vetDataScience/blob/hojas_excel/5.2_Cuantitativos.xlsx?raw=true"/> 
      ...
      <SubChapter id="visualizacion">
        ...
        <SubTitle title="5.3.1- Variables cuantitativas gráficos de dispersión" />
      ...
      <SubChapter id="dispersion">
        ...
        <Paragraph
          texto={<><p>
            ...
            <a href="https://www.investopedia.com/terms/s/standarddeviation.asp" target="_blank"><u>Desviación Estándar</u></a>. 
            La desviación estándar, es la raíz cuadrada de la varianza  y es <b>la medida de variabilidad de mayor uso para calcular la dispersión
            de los datos. En Excel la función es '=DESVESTA' o '=STDEV' en inglés.
            </b>
          </p></>}
        />
      </SubChapter>
      ...
      <SubChapter id="ejemplo">
        ...
        <ImagePlus
          ...
          width="40%"
          max_zoom ="50%"
         texto="Framento de un registro de ceba porcina"
        />
        <Paragraph texto = "Recordemos que la conversión es un dato calculado que mide la cantidad de alimento utilizado por unidad de peso (en este caso kg) ganado. La fórmula general de la conversión es:"/>
        ...
        <ImagePlus
          ...
          max_zoom ="50%"
          alt="Formula Mediana"
          texto="fórmula de la conversión"
        />
      ...
      <center> <SubTitle title="Construcción de resultados de estadística descriptiva" /></center> 
        <Video
          id="KICATP9ceMY"
...
<DownloadButton link = "https://github.com/HectorDR/vetDataScience/blob/hojas_excel/5.4.1_Medidas_tend_central.xlsx"/> 
      ...
      <SubChapter id="covarianza">
        ...
        <SubTitle title="5.6.1 Covarianza" />
        <Paragraph
        ...
        />
         <SubTitle title="Fórmula de la covarianza muestral" />
      ...
      <Paragraph
        ...
        <SubTitle title="5.6.2 Correlación" />
        <Paragraph
...
<Paragraph
        ...
        <Paragraph
          texto="Tenemos los promedios de los registros de producción de 10 granjas de cerdas de cría de una región de Caldas (Colombia) como lo muestra el registro a continuación."
        />
...
<DownloadButton link = "https://github.com/HectorDR/vetDataScience/blob/hojas_excel/5.6_cov_correl.xlsx?raw=true"/> 
      ...
      <ReferencesBlock
        references={[
          ...
          <a href="https://www.investopedia.com/terms/s/standarddeviation.asp" target="_blank">* Hargrave, M., 2021. <u> Standard Deviation </u> en portal Investopedia.com</a>,
