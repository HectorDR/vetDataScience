...
<Paragraph texto = { <> <p> los módulos que se presentan están diseñados de manera que cualquier persona con conocimientos básicos en matemáticas y estadística (o deseos de aprender) pueda beneficiarse de ellos.  Ojalá esté familiarizado con la hoja de cálculo Microsoft® Excel®, pues esta será la principal herramienta para desarrollar los ejercicios.  Es importante anotar que, aunque Excel es muy útil, es tan solo una de las herramientas de las que se dispone. Independiente de si la configuración de su Excel sea en Inglés o Español o si trabaje en ambiente Window o Mac las funciones y los procesos se mantienen muy parecidos, solo algunos pequeños ajustes son necesarios como cambios en los nombres de las funciones que yo trataré de aplicar en cada caso especialmente en el caso de las funciones aclararé como se escriben en  <a href="https://functiontranslator.com/es/"target="_blank"><u>cada idioma</u></a>, sin embargo, en la red se encuentran suficientes recursos aclaratorios. Sobra decir que algo de tiempo y dedicación semanal, una buena conexión a internet y un laptop o un computador de mesa son necesarios.</p></>}/>
</SubChapter>
</section>
...
<Paragraph texto = {<><p>Quiero agradecer especialmente a Robert Davis porque sin su apoyo no hubiera podido desarrollar este proyecto. A Victor Cabrera quien en gran medida me inspiró a desarrollar este trabajo y sobre todo creyó en mí. A Liliana Fadul por todas las horas en que me escuchó pacientemente hablar sobre este proyecto y por su tiempo ayudandome a revisarlo. A Roger Cue quien alguna vez me dijo 'Si usted quiere aprender, yo quiero enseñarle'. A <a href="https://www.linkedin.com/in/johan-sebastian-c-mazo" target="_blank"><u>Johan Castillo Mazo</u></a> por su contribución al mejoramiento de esta página con nuevas tecnologias y finalmente a todos los estudiantes e investigadores de las ciencias agropecuarias por su esfuerzo y dedicación para que con sus aportes el campo se fortalezca y desarrolle cada día mas y mejor. </p></>}/>
