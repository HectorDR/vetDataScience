...
<div>
   <Helmet>
  <title>7.1-Que es el análisis de varianza (ANAVA)</title>
  <meta name="description" content="Que es el análisis de varianza (ANAVA)"/>
  <meta name='keywords'
  content='la regresion lineal, regresion multiple, regresion cuadratica, regresion con interaccion, variables dummy'/>
    </Helmet>
   <main>
...
<DownloadButton link = "https://github.com/HectorDR/vetDataScience/blob/hojas_excel/7.6_Reg_lineal.xlsx?raw=true"/> 
    ...
    <SubChapter id = "regmult">
        ...
        <Paragraph texto = {<><p>
            En la ecuación superior el valor de Y esta dado por <b>𝛃<sub>0</sub></b> que es el intercepto o el valor de <b>Y</b> cuando <b>X</b> vale 0 y los valores de <b>𝛃<sub>n</sub></b> representan cada una de las constantes para las pendiente de los multiples valores de <b>X<sub>n</sub></b> cuando los demás predictores se mantienen fijos y <b>𝛆</b> es el error. Típicamente se asume que el error es independiente de X.<br/><br/>
    ...
    <SubChapter id = "regquad">
        ...
        />
        <Paragraph texto = {<><p>
          "Donde <b>Y</b> es la variable dependiente, <b>µ</b> es el intercepto, <b>𝛃<sub>1</sub></b> es el coeficiente de inclinación de la diagonal, <b>X<sub>i</sub> </b> 
          es la variable independiente, <b>𝛃<sub>2</sub></b> es el coeficiente de la variable X<sub>i</sub> elevada al cuadrado, <b>X<sup>2</sup></b>  es el cuadrado de la variable independiente y <b>𝜀</b> representa el error.<br/> <br/>
          Para este ejemplo vamos a seguir con los datos tomados de Cue (2019) donde un grupo de 50 vacas fue alimentado con dietas utilizando varios niveles de alimentación (50 hasta 140 lb de henolaje) con varias densidades de energía (0.8 hasta 1.6).<br />
...
<br/>
      <ImagePlus
        ...
        <Paragraph texto = {<><p>
          Donde Y es la variable dependiente, <b>𝝁</b> es el intercepto, <b>𝜷<sub>1</sub></b>  es el coeficiente de inclinación de la variable independiente <b>X<sub>1</sub></b>, igual para <b>β<sub>2</sub> X<sub>2</sub></b>, <b>𝜷<sub>3</sub></b>  es el coeficiente de la inclinación de la interacción entre <b>X<sub>1</sub> y X<sub>2</sub></b> y <b>𝝐</b> representa el error.  <br /><br/>
