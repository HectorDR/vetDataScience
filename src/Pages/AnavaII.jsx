...
<DownloadButton link = "https://github.com/HectorDR/vetDataScience/blob/hojas_excel/7.6_Reg_lineal.xlsx?raw=true"/> 
    ...
    <SubChapter id = "regmult">
        ...
        La segunda tabla nos presenta el análisis de varianza como tal y como podemos ver en este caso la significancia de F es inferior a 0.0001 por tanto el modelo es estadisticamente significativo.  Finalmente, la tercera tabla detalla los componentes del modelo. Los valores de P para ambos coponentes son inferiores a 0.0001 por lo tanto son estadisticamente significativos y podemos incluirlos en el modelo y recharzar la H<sub>0</sub> para ambas variables independientes, y aceptamos la H<sub>1</sub> pues con un 95% de confianza podemos decir que tanto la densidad de la energía como la ingesta de alimento tienen un efecto significativo sobre la producción de leche. 
        <br />
    ...
    <SubChapter id = "regquad">
        ...
        <Paragraph texto = {<><p>
          ...
          Para este ejemplo vamos a seguir con los datos tomados de Cue (2019) donde un grupo de 50 vacas fue alimentado con dietas utilizando varios niveles de ingesta de alimento (50 hasta 140 lb de henolaje) con varias densidades de energía (0.8 hasta 1.6).<br />
      ...
      <Paragraph texto = {<><p>
         ...
         <br/>
         En entonces para este modelo no podemos aceptar la H<sub>0</sub> y aceptamos la H<sub>1</sub> es decir, con un 95% de confianza podemos afirmar que existe un efecto cuadrático significativo de la ingesta de alimento sobre la producción de leche y existe un efecto significativo de la densidad de la energía en la dieta sobre la producción de leche. 
         </p></>}/>
