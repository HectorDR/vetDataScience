...
const Analisis = () => {
 ...
 <div>
   <Helmet>
  <title>6- Pruebas de hipótesis e intervalos</title>
  <meta name="description" content="Pruebas de hipótesis e intervalos"/>
  <meta name='keywords'
  content='pruebas de hipotesis, pruebas de una cola, pruebas de dos colas, intervalos de confianza, varianza conocida, varianza desconocida, medias dependientes, medias independientes'/>
    </Helmet>
   <main>
...
<Paragraph texto = {<><p>Cuantifica las oscilaciones de la media muestral alrededor de la media poblacional, es decir, cuando tomamos varias muestras de
 ...
 <ImagePlus
  ...
  <Video id="pUAyXfzRJJ4" title="Pruebas de una o dos colas" />
...
/>
<SubTitle title = "6.3.1- Intervalo con varianza poblacional conocida "/>

<Paragraph texto = {<><p>
  Para este tipo de intervalo muestral debemos tener en cuenta
  <a href="https://www.greelane.com/es/ciencia-tecnolog%c3%ada-matem%c3%a1ticas/mates/hypothesis-tests-z-test-function-excel-3126622/" target = "_blank">(<u>greelane.com,2018</u>)</a>: </p> <br/>
  <ul> <b>
...
<li> - Se desconoce la media de la población. </li>
  ...
  <p>Para este intervalo podemos fijar de antemano el grado de confianza de que el verdadero valor de la media 𝛍x quede incluido en el rango. 
...
<center><p> <b> Donde: z (1-α/2) = valor de la variable normal estándar que determina una cola superior de medida 𝛂/2</b></p></center> 
<br />
<Paragraph texto = {<><p>
  ...
  significativa entre la media encontrada en el muestreo y la media suministrada por el administrador.<br/><br/>Entonces en
...
<ImagePlus
          ...
          max_zoom = "30%"
        />
<Paragraph texto = {<><p><center>Donde <b>𝛸</b> es la media muestral, <b>𝛍</b> es la media poblacional, <b>s</b> es la desviación estándar
de la muestra y <b>n</b> el tamaño de la muestra.</center><br /><br/>
...
<ImagePlus
        ...
        />
<Paragraph texto = {<><p>
  <center> Donde <b>t</b><b><sub>(k,1-α/2)</sub></b> Es el valor de la variable con distribución t con <b>k = nx + ny – 2</b> grados de libertad que determina
  un área superior de media <b>𝛼/2</b> </center> <br/><br/>Como se desconoce la varianza poblacional debemos calcular la varianza 
...
<Paragraph texto = {<>
  ...
  <p>Ejemplo: Un propietario tiene dos hatos lecheros, sus registros son escasos y contrata un asistente técnico para que le ayude a mejorar producción.
     El asistente desea saber si existen diferencias en las medias de producción de ambas fincas.  Para ello tomó los registros de producción del último
     año y seleccionó 27 lactacias al azar de cada uno de los hatos.  Desconocemos las varianzas poblacionales, pero podemos calcular las de las
...
<ImagePlus
        ...
        />
<Paragraph texto = {<>
<p>El propietario desea conocer si existe diferencia entre las medias de ambos grupos con un 95% de confianza.<br/>
