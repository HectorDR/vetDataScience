        ...
        <section id = "tabla" className = "container">
          ...
          />
            ...
            <SubChapter id = "definicion">
                ...
                <Paragraph
                    texto ={["La ciencia de los datos abarca un amplio espectro de habilidades que se requieren para analizar los datos obtenidos de diferentes fuentes tanto dentro de la finca como por fuera.  De acuerdo con" , <a href="https://www.oracle.com/ca-en/data-science/what-is-data-science.html"> <u>Oracle</u></a>," la ciencia de los datos es una combinación de varios campos como la estadística, el método científico y el análisis de datos que se usan para extraer valor de los datos, o en otras palabras obtener información útil."]}
                
                />
                <Paragraph texto = {["El manejo y análisis de los datos requiere de ciertos conocimientos, experiencia y algunas habilidades de programación que se puede aprender,  pero fundamentalmente se necesita curiosidad, interés y unas buenas bases de matemáticas y estadística que permitan dar respuesta adecuada a las preguntas planteadas. Esto se resume en un artículo de ",<a href="https://ischoolonline.berkeley.edu/data-science/what-is-data-science/"><u>McKinsey&Company</u></a>,
                ". Este artículo retoma las palabras de  Hal Varian antiguo ecomista en jefe de Google quien manifiesta que para hacer  ciencia de los datos  se requiere: 1- identificar preguntas relevantes, 2- recolectar datos de múltiples fuentes, 3- organizar la información, 4- traducir los resultados en soluciones y 5- comunicar los hallazgos en una manera que afecte positivamente la decisión."]}
                />
                <Paragraph
            ...
            <SubChapter id = "datos">
                ...
                <Paragraph
                texto = {["Los datos que se generan a todo nivel tanto dentro de la empresa como por fuera de la operación y aun no han sido editados, los podemos denominar datos crudos o datos primarios. Estos datos se caracterizan porque no han sido manipulados ni tabulados. Según el ",<a href="https://www.statista.com/statistics-glossary/definition/351/raw_data/"><u>Statista</u> </a>," una vez que los diferentes datos han sido procesados es decir integrados, normalizados o agregados podríamos hablar de datos secundarios y estos datos se caracterizan porque no necesariamente contienen los datos originales sino que tienen algún tipo de valor agregado o información."]}/>

               <Paragraph
               texto= {["Desde el punto de vista práctico, los datos crudos se refieren a tablas de datos donde cada fila contiene una observación y cada columna representa una variable ",<a href="https://www.displayr.com/what-is-raw-data/"><u>(Bock, 2018)</u></a>,". Entonces, lo mas importante es tener en cuenta que la data cruda es esa data que no ha sido procesada. Un ejemplo claro son los datos de producción que se recogen a diario en un galpón de ponedoras (ver la tabla inferior). Estos registros solo contiene la producción del día, el consumo de alimento y la variación en la población de aves, que sería la materia prima para comenzar a realizar los análisis, sin embargo, no hay ningún tipo de tabulación o procesamiento de los datos. De hecho en la mayoría de nuestras fincas estos datos aún se llevan a la mano y no son tabulados." ]}
               />
                ...
                />
                <Paragraph
                texto= {[<a href="http://repositorio.bibliotecaorton.catie.ac.cr/bitstream/handle/11554/8001/Manual_de_producion_manejo_aves_de_patio.pdf"> <center> <p>Fuente: <u>Manual de producción, manejo de aves de patio</u></p></center> </a>]}
                />
                ...
                />
                <Paragraph
                texto = {[<p> <center> Fuente: Identification of the Rumination in Cattle Using Support Vector Machines with Motion-Sensitive Bolus Sensors, Hamilton et al. 2019 </center></p>]}
                />
                <Paragraph
                texto = {["Finalmente, existe una tercera categoría que es la data semi-estructurada. La principal característica es que tiene algo de estructura, pero no toda la estructura requerida para ajustarse a los requerimientos de una base de datos.  La data semi-estructurada posee algunos atributos para separar varias entidades dentro de la data. Algunos ejemplos son XML, JSON, Emails, NoSQL DBs, seguimiento de eventos, y páginas web ", <a href="https://www.sisense.com/blog/understanding-structured-and-unstructured-data/"><u>(De Couto, 2020).</u></a>
