  ...
  content='probabilidades, permutaciones, combinaciones, variaciones'/>
   ...
   <main>
                ...
                <SubChapter id ="definicion">
                    ...
                    <Paragraph texto = {<><p>Podríamos definir una probabilidad como la medición de la posibilidad de que un evento ocurra en una situación
                      ...
                      <a href="https://towardsdatascience.com/basic-probability-theory-and-statistics-3105ab637213" target="_blank"><u>(Radke, 2017)</u></a>. Un ejemplo típico
                       sería el sexo al nacer (XX o XY).  En teoría la probabilidad debería ser 50% de que nazca macho y 50% de que sea hembra (enc condiciones naturales).  El clásico 
                       ejemplo de una probabilidad es al tirar al aire una moneda cuales son las probabilidades de obtener cara o sello. Entonces otra manera de definir la
            ...
            <ImagePlus 
                ...
                />  
                <center><p><b></b>Donde la probabilidad de A dado B es igual a la probabilidad de A y la probabilidad de B dado A es igual a la probabilidad de B</p></center>  
                <br />
          ...
          images={[
            ...
            {
              image: probind3,
              texto: "Probabilidad de sacar un animal blanco del corral A y un animal blanco del corral B",
            },
          ]}
        />
