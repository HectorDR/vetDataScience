    ...
    return(
        ...
        <section id = "tabla" className = "container">
            ...
            <SubChapter id = "condicional">
                ...
                </ul>, <br /> ,"Entonces el investigador tiene  un 56% de probabilidades de seleccionar una finca que también tenga orientación reforestadora si su criterio inicial ha sido seleccionar una finca ganadera."]}/>
        ...
        <SubChapter id = "multiplicacion">
           ...
           <Paragraph texto ={[ "La regla de la multiplicación para eventos dependientes se da cuando los eventos están relacionados entre si. La fórmula esta definida de la siguiente manera:", <h3> <center> P(A∩B)=P(A|B)*P(B)</center></h3>, <br/>, "Donde la probabilidad esta dada por la probabilidad de A dado que B ocurrio y multiplicado por la probabilidad de B.", <br/>,"Por ejemplo, si voy a sacar dos novillas de un corral donde hay 4 blancas, 5 pardas y 2 negras, cual es la probabilidad de que la segunda novilla sea negra sabiendo que la primera también fue negra (no hay reemplazos dentro del corral).", <br/>, "El espacio muestral en este caso sería de: 4 novillas blancas + 5 novillas pardas +2 novillas negras = 11 novillas, entonces,"]}/>
           <ImagePlus 
                width = "30%"
                max_zoom = "70%"
                image = {mult}
            ...
            <Paragraph texto = {["En el segundo caso de la regla de la multiplicación, los eventos son independientes cuando la ocurrencia de uno de ellos no afecta la ocurrencia del otro. la fórmula se expresa de la siguiente manera:", <br/>, <h3><center>P(A∪B)=P(A)*P(B)</center></h3>,<b/>,"donde la Probabilidad esta dada por la probabilidad de A multiplicada por la probabilidad de B",<br/>,"Por ejemplo, en una finca hay 100 novillas de las cuales 35 son Holstein. De las 100 novillas 75 han sido inseminadas por primera vez. El hecho de que la novilla sea Holstein no tiene nada que ver con que la novilla haya sido inseminada o no. Ahora nos interesa saber,cuál es la probabilidad que una de las novillas Holstein haya sido inseminada?"]}/>
        ...
        <SubTitle title ="3.12- El teorema de Bayes"/>
           ...
           <ImagePlus 
                ...
                />  
            <Paragraph texto = "Donde A y B son eventos y B ≠ 0. P(A│B) es la probabilidad de A dado que ha ocurrido el evento B y P(B|A) es la probabilidad de B dado que ha ocurrido el evento A.  "/>
            ...
            <Paragraph texto ={[ "Entonces tenemos que: ", <ul>
                <center><li>A: animales de alta producción= 68% </li></center>
                <center><li>B: animales de alta resistencia a mastitis= 22%</li></center>
                <center><li>(B|A): animales de alta resistencia a mastitis dado que son de alta producción: 26%</li></center>
                <center><li>(A|B): animales de alta producción dado que son resistentes a mastitis: ?</li></center>
            </ul>]}/>
            <ImagePlus 
                width = "30%"
                max_zoom = "70%"
