...
const ProbabilidadesIII =()=>{
    return(
        ...
        chapter_image= {bufalas}>
            ...
            <Paragraph texto = {<><p>Analicemos una alteración genética a nivel de un solo gen como  <a href="http://www.ainfo.inia.uy/digital/bitstream/item/14026/1/st-253-p163.pdf" targe = "_blank"><u>el Pie de Mula o Sindactilia</u></a>. Si seleccionamos un toro portador de esta malformación, en un lote de hembras de las cuales el 12% de las mismas tambien son portadoras de la misma condición, 1- cuál es la probabilidad que tienen las crias de este lote de expresar la condición?. </p></>}/>
