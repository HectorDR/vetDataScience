...
const ProbabilidadesIII =()=>{
 ...
 <div>
           <Helmet>
  <title>3- Principios generales de probabilidades- genetica cualitativa-</title>
  <meta name="description" content="Principios generales de probabilidades - genetica cualitativa"/>
  <meta name='keywords'
  content='genetica cualitativa'/>
    </Helmet>
   <main>
            ...
            <section id = "tabla" className = "container">
                ...
                <Paragraph texto = {<><p>La forma de cuantificar las probabilidades de las combinaciones geneticas de dos individuos que se aparean, se puede determinar por medio del <b>cuadro de Punnett</b> (ver recuadro inferior). En el eje horizontal se lista la combinacion de genes del padre, y a la izquierda los de la madre. Se combina un valor de cada padre en la casilla correspondiente y mirando los resultados se calcula la probabilidad que tienen las crías de expresar el caracter en estudio. </p></>}/>      
                
                <Paragraph texto = {<><p>Un ejemplo sencillo es utilizar los colores del manto del ganado Holstein. Tenemos homocigoto dominante para manto negro expresado como <b>BB</b>, Heterocigoto para manto negro (portador rojo) <b>Bb</b> y finalmente homocigoto recesivo que será el único que pueda expresar el manto rojo <b>bb</b>. Si cruzamos dos animales homocigotos un Macho negro BB con hembra roja bb y miramos el cuadro de Punnet los resultados serían como se presentan en el recuadro inferior.</p></>}/>
            ...
            <Paragraph texto = {<><p>Analicemos una alteración genética a nivel de un solo gen como  <a href="http://www.ainfo.inia.uy/digital/bitstream/item/14026/1/st-253-p163.pdf" targe = "_blank"><u>el Pie de Mula o Sindactilia</u></a>. Si seleccionamos un toro portador de esta malformación, en un lote de hembras de las cuales el 12% de las mismas tambien son portadoras de la misma condición, 1- cuál es la probabilidad que tienen las crías de este lote de expresar la condición sindactilia?. </p></>}/>
         ...
         references={[
          ...
          <a href="http://www.ainfo.inia.uy/digital/bitstream/item/14026/1/st-253-p163.pdf" target = "_blank">* Federici M.T. et al., 2019, <u>* Identificación de bovinos Holando portadores de mutaciones asociadas al síndrome Sindactilia utilizando el panel Arbos1</u> en portal del Instituto Nacional de Investigación, Uruguay </a> ,
          <a href="http://www.holsteinfoundation.org/pdf_doc/workbooks/Gen_Sire_WKBK.pdf" target = "_blank">* Holstein foundation, 2021. <u>Understanding Genetics and the Sire Summaries </u>,en PDF en línea </a>,
